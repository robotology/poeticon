...
void  pbCGTG (IplImage *,IplImage*, IplImage*, yarp::os::Property &fileLoc);
void  pbCGTG_NoMaxSup (IplImage *,IplImage*, IplImage*, yarp::os::Property &fileLoc);
...
// replaced macro with template, https://stackoverflow.com/a/28457179
