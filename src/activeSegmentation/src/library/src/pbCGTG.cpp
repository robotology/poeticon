...
//------------------------------------------------------------------------------
void pbCGTG(IplImage *im, IplImage* grad, IplImage* ori, yarp::os::Property &fileLoc)
{
	...
	CvMat** tg     = detTG(im, norient, gtheta, fileLoc);
   	printf("\n");
...
//------------------------------------------------------------------------------
void pbCGTG_NoMaxSup(IplImage *im, IplImage* grad, IplImage* ori, yarp::os::Property &fileLoc){
	double BETA[] = {-4.5016,    1.6921,    0.9562,    1.0045,    2.8116};
